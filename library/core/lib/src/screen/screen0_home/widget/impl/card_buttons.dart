  ...
  return ListenableBuilder(
    ...
    builder: (context, child) {
      ...
      final double progress =
          (activity is Swipe || activity == null) && position != null && position.offset.toAxisDirection().isHorizontal
...
class ShuffleAnimationButton extends StatelessWidget {
  const ShuffleAnimationButton(this.onTap, {super.key});
